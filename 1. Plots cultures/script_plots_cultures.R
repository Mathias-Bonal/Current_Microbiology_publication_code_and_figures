...
#
# Create the plots of mono-, bi- and quadri-cultures as presented in Bonal et al, 2023
#
#
...
# Create plots with monocultures and bi-cultures triplicates with time in x axis and abundances 
# (in ln values) in y axis
...
# Load data
m78R <- read_excel("monocultures_ln.xlsx", sheet="78R")
m124Z <- read_excel("monocultures_ln.xlsx", sheet="124Z")
m515Z <- read_excel("monocultures_ln.xlsx", sheet="515Z")
m1315Z <- read_excel("monocultures_ln.xlsx", sheet="1315Z")
...
# Create a triangular matrix of plots with monocultures in diagonal and bi-cultures in the 
# lower triangle (Fig. 2)
...
plot_matrix_tri <- ggarrange(s78R, NA, NA, NA,     
                             ...
                             label.x=0.1, label.y=1, common.legend=TRUE,
                             ncol = 4, nrow = 4)  
plot_matrix_tri
...
ggsave(file="triangular_matrix_ln.png", plot=final_matrix_tri, width=15, height=7.5)
...
# Create the same figure by plotting the same cultures, this time without ln-transforming the 
# abundance values in y axis
...
plot_matrix_tri <- ggarrange(tot78R, NA, NA, NA,     
                             ...
                             labels = c("78R", "", "", "",   
                                        ...
                                        "78R_515Z", "124Z_515Z", "515Z", "",
                                        "78R_1315Z", "124Z_1315Z", "515Z_1315Z", "1315Z"),
                             label.x=0.15, label.y=1, common.legend=TRUE,
                             ncol = 4, nrow = 4)  
plot_matrix_tri
...
ggsave(file="triangular_matrix_tot.png", plot=final_matrix_tri, width=15, height=7.5)
...
# Load data
tot78R_124Z <- read_excel("co-cultures_cell_counts.xlsx", sheet="78R_124Z_tot")
tot78R_515Z <- read_excel("co-cultures_cell_counts.xlsx", sheet="78R_515Z_tot")
tot78R_1315Z <- read_excel("co-cultures_cell_counts.xlsx", sheet="78R_1315Z_tot")
tot124Z_515Z <- read_excel("co-cultures_cell_counts.xlsx", sheet="124Z_515Z_tot")
tot124Z_1315Z <- read_excel("co-cultures_cell_counts.xlsx", sheet="124Z_1315Z_tot")
tot515Z_1315Z <- read_excel("co-cultures_cell_counts.xlsx", sheet="515Z_1315Z_tot")
tot_quadri <- read_excel("co-cultures_cell_counts.xlsx", sheet="quadri_tot")
...
ggsave(file="cocultures_tot.png", plot=plot_cocultures_tot, width=15, height=7.5)
...
# Create plots for each quadri-culture replicate, with ln-transformed abundances (Fig.S3)
